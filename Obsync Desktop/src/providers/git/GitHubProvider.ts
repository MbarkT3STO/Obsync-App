/**
 * GitHubProvider — syncs vaults to GitHub repositories.
 *
 * Auth: Personal Access Token (PAT) with repo scope.
 * Remote URL format: https://{token}@github.com/{owner}/{repo}.git
 */
...
export class GitHubProvider extends BaseGitProvider {
  ...
  protected getRemoteUrl(credentials: ProviderCredentials): string {
    ...
    // Normalise: strip existing credentials, inject PAT
